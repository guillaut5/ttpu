...
class WazeRouteCalculator(object):
    ...
    def getLocationFromAdress(self,address):
    ...
    def address_to_coords(self, address):
        ...
        response_json = self.getLocationFromAdress(address)
    ...
    def get_route(self, start_address, end_address, npaths=1, time_delta=0):
        """Get route data from waze"""


        self.log.debug("From: %s - to: %s", start_address, end_address)
    ...
    def calc_route_info(self, start_address, end_address,real_time=True, stop_at_bounds=False, time_delta=0):
        """Calculate best route info."""

        route = self.get_route(start_address, end_address,1, time_delta)
